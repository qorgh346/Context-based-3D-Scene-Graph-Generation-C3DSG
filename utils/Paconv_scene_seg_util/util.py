...
# /home/baebro/hojun_ws/PAConv/scene_seg/config/s3dis
def get_parser():
    parser = argparse.ArgumentParser(description='PAConv: Point Cloud Semantic Segmentation')
    parser.add_argument('--config', type=str, default='/home/baebro/hojun_ws/PAConv/scene_seg/config/s3dis/s3dis_pointnet2_paconv.yaml', help='config file')
