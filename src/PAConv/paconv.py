...
import os
import sys
from utils.Paconv_scene_seg_util.paconv_util import weight_init, assign_score, get_ed, assign_kernel_withoutk
from cuda_lib.lib.paconv_lib.functional import assign_score_withk as assign_score_cuda
...
class PAConv(nn.Module):
    ...
    def forward(self, args):
        r"""
            ...
            """
        # print('?arg[0] : {} , {}'.format(args[0].device,args[0].size()))
        # print('arg[1] : {} , {} '.format(args[1].device,args[1].size()))
        # print(len(args))
        in_feat, grouped_xyz= args
        # print('what??? ',in_feat.size())
