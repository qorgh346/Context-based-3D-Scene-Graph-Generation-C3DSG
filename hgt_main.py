...
from CSGGN.src.models.HeteroSceneGraphGeneraionNetwork import HGT_3DSSG
...
def main():
    ...
    model = HGT_3DSSG(config, args=args)
...
def load_config():
    ...
    parser.add_argument('--config', type=str, default='config_hojun.json',
