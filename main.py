...
from src.CSGGNetwork import CSGGN
...
def load_config():
    ...
    parser.add_argument('--config', type=str, default='config_hojun.json', help='configuration file name. Relative path under given path (default: config.yml)')
    ...
    parser.add_argument('--mode', type=str, default='train', choices=['train','trace','eval'], help='mode. can be [train,trace,eval]')
